...
const SPECIAL: Record<string, () => React.ReactNode> = {
  ...
  ca: () => (
    <>
      ...
      <path
        d="M18 9 l1.5 4 4-1-2 3.5 3 2-3.5 1 .5 4-3.5-2-3.5 2 .5-4-3.5-1 3-2-2-3.5 4 1z"
        fill="#FF0000"
      />
    </>
  ),
  ...
  tr: () => (
    <>
      ...
      <polygon
        points="22,18 25,17 23,19.5 25,22 22,21 21,24 20,21 17,22 19,19.5 17,17 20,18 21,15"
        fill="#FFF"
      />
    </>
  ),
  ...
  return (
    <Squircle size={size}>
      {special ? (
        ...
        <rect width="36" height="36" fill="#E5E7EB" />
      )}
    </Squircle>
  );
});
