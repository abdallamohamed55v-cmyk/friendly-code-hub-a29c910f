...
import { ArrowLeft, Download, RotateCcw, Share2, Upload, Loader2 } from "lucide-react";
    ...
    <div className="min-h-[100dvh] w-full bg-paper text-ink selection:bg-ink/15">
      ...
      <div className="lg:hidden relative min-h-[100dvh] flex flex-col">
        ...
        <motion.div
          ...
          className="relative z-10 mt-auto mx-3 mb-3 rounded-ios-lg bg-paper border border-ink/10 shadow-[0_-8px_40px_-12px_rgba(0,0,0,0.18)] px-6 pt-6 pb-7"
        >
