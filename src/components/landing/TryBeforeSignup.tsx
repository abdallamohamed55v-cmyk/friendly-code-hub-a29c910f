...
const INTENTS: { id: Intent; label: string; icon: typeof MessageSquare; placeholder: string }[] = [
  {
    ...
    label: "Chat",
    icon: MessageSquare,
    placeholder: "Ask anything... e.g.: summarize the latest AI news for me",
  },
  {
    id: "slides",
    label: "Slides",
    icon: Presentation,
    placeholder: "Design a 10-slide presentation about the future of education",
  },
  {
    id: "docs",
    label: "Document",
    icon: FileText,
    placeholder: "Write a detailed business plan for a delivery app",
  },
];
